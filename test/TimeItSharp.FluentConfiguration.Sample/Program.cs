...
{
    private static Task<int> Main() => RunSampleAsync();

    [RequiresUnreferencedCode("The sample intentionally exercises reflection-based extension loading.")]
    private static async Task<int> RunSampleAsync()
    {
        ...
        return await TimeItEngine.RunAsync(
